            ...
            <div className='flex justify-center'>
                <div className='flex  flex-col justify-center text-center'>
                    ...
                    <form className='flex flex-col gap-4'  onSubmit={handleSubmit(onSubmit)}>
                        <div>
                            <input className='signup-input' type="text" placeholder='Username' name='username'  {...register('username')} />
                            {errors.username && (
                        ...
                        <div>
                            <input className='signup-input' type="text"placeholder='password' name='password'  {...register('password')} />
                                {errors.password && (
                    ...
                    <div className='flex  gap-[4px] mt-2 justify-center'>
                        <input type="checkbox" name='newHere'/>
